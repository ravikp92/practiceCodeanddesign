...
public class BookMyShow {
    ...
    private void createBooking(City userCity, String movieName) {
        ...
        Map<Theater, List<Show>> showsTheatreWise = src.main.java.com.example.demo.designquestions.bookmyshow.TheaterController.getAllShow(interestedMovie, userCity);
    ...
    private void createTheatre() {
        ...
        src.main.java.com.example.demo.designquestions.bookmyshow.TheaterController.addTheatre(inoxTheatre, City.Bangalore);
        src.main.java.com.example.demo.designquestions.bookmyshow.TheaterController.addTheatre(pvrTheatre, City.Delhi);
    ...
    private List<Seat> createSeats() {
        ...
        for (int i = 70; i < 100; i++) {
            Seat seat = new Seat();
            seat.setId(i);
            seat.setCategory(Category.PLATINUM.PLATINUM);
            seats.add(seat);
        }
